...
/* This program is not according the new ANSI rules,
   therefore we disable the warnings 35 and 135 */

//#pragma WARNING disable = 35, 135
...
extern void initserial (void);
#define HZ  1000L   /* 2 500 000 Hz Timer input frequency */
#elif defined CPUARM
...
POUT(int N, int J, int K, float X1, float X2, float X3, float X4)  {/* SUBROUTINE POUT(N,J,K,X1,X2,X3,X4); */
/*      IMPLICIT REAL*4 (A-H,O-Z); */
...
#ifndef NOPRINT
// time1 = time0 = ptime = 0;
        printf ("%3d%3d %7d%7d", (int)((time1-time0)/ 10000),(int)((time1-ptime)/10000),N,J);
